            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4" >
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <div className="flex gap-4">
                        <input onChange={(e) => setFiles(e.target.files)} type="file" id="images" className="p-3 border-gray-300 rounded w-full" accept="image/*" multiple />
                        <button type="button"
                            disabled={uploading}
                            onClick={handImageSubmit}
